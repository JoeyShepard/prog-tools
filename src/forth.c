...
static int handle_VKEY_EXE(struct ForthInfo *forth,struct ConsoleInfo *console,struct ForthCompileInfo *compile)
{
    ...
    //TODO: check process result - possibly overwritten below
...
int forth(int command_ID, struct WindowInfo *windows, int selected_window)
{
    ...
    else
    {
        ...
        //Restore data for compiling
        compile.optimize=forth->optimize_copy;
    ...
    //TODO: don't need this to be separate function
    ...
    while (1)
    {
        ...
        if (save_exit==true)
        {
            ...
            //Save compile state
            forth->optimize_copy=compile.optimize;
